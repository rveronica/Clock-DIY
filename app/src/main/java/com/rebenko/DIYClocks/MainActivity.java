...
public class MainActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    final String ADD_IND_ID = "ca-app-pub-9595835527986323/1125434279";
    final String DIR_SD = "diy_clock";
    final String FILE_SD = "clock";
    final String APP_NAME = "DIY Clocks";
    final String APP_URL = "https://play.google.com/store/apps/details?id=com.rebenko.DIYClocks";
    final String APP_DEV_URL = "https://play.google.com/store/apps/developer?id=VeronicaR";
    final String MORE_IDEAS_URL = "http://www.homedesigndiy.com/tag/clock/";
   ...
   // private GestureDetectorCompat mDetector;
    ...
    public static int[] imageIds = {R.drawable.i0,
            ...
            R.drawable.i101, R.drawable.i102, R.drawable.i103, R.drawable.i104, R.drawable.i105, R.drawable.i106, R.drawable.i107, R.drawable.i108, R.drawable.i109, R.drawable.i110,
    };
        ...
        switch (item.getItemId()) {
            ...
            case R.id.content_rss:
               ...
               /* if (language.equals("rus")) {
                ...
                // instead of commented code above
                intentRss = new Intent(Intent.ACTION_VIEW, Uri.parse(MORE_IDEAS_URL));
